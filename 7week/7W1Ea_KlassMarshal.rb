...
require_relative '7W1E_Klass'

greeting = Klass.new("hello")
msg = greeting.say_hello

File.open('Klass_Marshal', 'w+') do |file|
  Marshal.dump(msg, file)
end

File.open('Klass_Marshal') do |file|
  puts Marshal.load(file)
end
